...
import type { FrostOptions } from "./Frost";

// Frost is a ~1300-line WebGL shader engine. Defer its code to a separate chunk
// that only loads once the About section scrolls near the viewport; the
// IntersectionObserver below gates rendering, so visuals are unchanged.
const Frost = lazy(() => import("./Frost"));
